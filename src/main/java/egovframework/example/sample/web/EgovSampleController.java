...
import egovframework.example.sample.service.FileRenamePolicy;
...
public class EgovSampleController {
	...
	public String addSample(@ModelAttribute("searchVO") SampleDefaultVO searchVO, SampleVO sampleVO,
		...
		MultipartFile mpfile = sampleVO.getMpfile();
		...
		/*
		 * 멀티 List<MultipartFile> fileList = mtf.getFiles("file"); String src =
		 * mtf.getParameter("src"); System.out.println("srccccccccccc : " + src);
		 * 
		 * String path =
		 ...
		 * System.out.println("originnnnnnn : " + originFileName);
		 * System.out.println("filesizeeeeee : " + fileSize);
		 * 
		...
		if (!mpfile.isEmpty()) {
			...
			sampleVO.setFile_name(file.getName());
		} else {
			sampleVO.setFile_name("");
		}
